...
export const Property1Apple = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill="url(#paint0_linear_1312_2332)"
      />
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1312_2332" x1="16" x2="16" y1="7" y2="23">
          <stop stopColor="#293645" />

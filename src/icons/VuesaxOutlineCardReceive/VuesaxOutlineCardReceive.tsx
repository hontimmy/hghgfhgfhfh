...
export const VuesaxOutlineCardReceive = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M20.0004 10.2499C19.8104 10.2499 19.6204 10.1799 19.4704 10.0299L17.4704 8.02994C17.1804 7.73994 17.1804 7.25994 17.4704 6.96994C17.7604 6.67994 18.2404 6.67994 18.5304 6.96994L20.5304 8.96994C20.8204 9.25994 20.8204 9.73994 20.5304 10.0299C20.3804 10.1799 20.1904 10.2499 20.0004 10.2499Z"
        fill="white"
      />
    </svg>
  );
